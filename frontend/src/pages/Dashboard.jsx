...
export default function Dashboard() {
  ...
  // Dados para o gráfico de barras (ano)
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <StatCard
              ...
              icon={Wallet}
              color={(monthlySummary?.balance || 0) >= 0
            ...
            <StatCard
              title="Receitas"
              value={monthlySummary?.total_income || 0}
              icon={TrendingUp}
              color="bg-blue-100 text-blue-600"
              subtitle={`${currentMonthName} / ${year}`}
            />
            <StatCard
              title="Despesas"
              value={monthlySummary?.total_expense || 0}
              icon={TrendingDown}
            ...
            <StatCard
              title="Transações"
              value={monthlySummary?.transaction_count || 0}
              icon={Receipt}
          ...
          <div className="card">
            <h3 className="text-base font-semibold text-gray-900 mb-4">
              Últimas Transações — {currentMonthName}
            </h3>
